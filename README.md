...
📄 View Government Schemes / Information
...
Model
Java classes handling data and database interactions

View
JSP pages with HTML and CSS for user interface

Controller
Servlets handling requests, responses, and application logic
